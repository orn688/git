...
submodule.noAddIgnored::
	Specifies whether `git add` should respect the `submodule.<name>.ignore>
	values. If true, `git add` will not stage any submodules that have
	`ignore` set to something besides "none".
	Defaults to false.
